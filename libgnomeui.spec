...
License:	LGPL
Group:		X11/Libraries
Source0:	http://ftp.gnome.org/pub/GNOME/sources/libgnomeui/2.19/%{name}-%{version}.tar.bz2
# Source0-md5:	a579b176321f55325135bcd8593243b1
...
Requires:	gnome-keyring-devel >= 2.19.91
